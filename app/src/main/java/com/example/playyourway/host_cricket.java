...
public class host_cricket extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gamesref = FirebaseDatabase.getInstance().getReference().child("Teams").child("cricketteams");
        mAuth = FirebaseAuth.getInstance();
        currentuserId = mAuth.getCurrentUser().getUid();
        userref = FirebaseDatabase.getInstance().getReference().child("Users").child(currentuserId);
        reqhostref = FirebaseDatabase.getInstance().getReference().child("Teams").child("cricketteams");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Games,GamesView>adapter = new FirebaseRecyclerAdapter<Games, GamesView>(options) {
            ...
            protected void onBindViewHolder(@NonNull final GamesView holder, int position, @NonNull Games model) {
                ...
                final String childid = "cricketteams";
                ...
                gamesref.child(teamIDs).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String capid = dataSnapshot.child("captain").getValue().toString();
                        ...
                        holder.pl.setText(pr + " Players left");
                            ...
                            holder.request.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    hostmap.put("status","cricketteams");
