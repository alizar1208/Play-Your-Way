...
public class host_tennis extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gamesref = FirebaseDatabase.getInstance().getReference().child("Teams").child("tennisteams");
        mAuth = FirebaseAuth.getInstance();
        currentuserId = mAuth.getCurrentUser().getUid();
        userref = FirebaseDatabase.getInstance().getReference().child("Users").child(currentuserId);
        mAuth = FirebaseAuth.getInstance();
        reqhostref = FirebaseDatabase.getInstance().getReference().child("Teams").child("tennisteams");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Games,GamesView>adapter = new FirebaseRecyclerAdapter<Games, GamesView>(options) {
            ...
            protected void onBindViewHolder(@NonNull final GamesView holder, int position, @NonNull Games model) {
                ...
                final String childid = "tennisteams";
